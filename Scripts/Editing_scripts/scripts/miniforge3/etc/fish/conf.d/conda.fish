set -gx CONDA_EXE (cygpath "C:/miniforge3\Scripts\conda.exe")
set _CONDA_ROOT (cygpath "C:/miniforge3")
set _CONDA_EXE (cygpath "C:/miniforge3\Scripts\conda.exe")
set -gx CONDA_PYTHON_EXE (cygpath "C:/miniforge3\python.exe")
